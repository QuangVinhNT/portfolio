...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center p-4 w-full fixed top-0 left-0 bg-white dark:bg-dark z-50 shadow">
      ...
      <ul className={`fixed h-dvh sm:relative pl-10 pr-28 py-4 sm:p-0 shadow sm:shadow-none top-0 ${isShowMenu ? 'left-0' : '-left-full'} sm:left-0 bg-white dark:bg-highlight dark:sm:bg-transparent sm:bg-transparent flex-col sm:flex-row flex gap-10 sm:items-center transition-all`}>
