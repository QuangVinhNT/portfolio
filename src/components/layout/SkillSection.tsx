...
const SkillSection = () => {
  ...
  return (
    <div className="mt-40 scroll-m-24 px-4 sm:px-0" id="skills" ref={ref}>
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={inView ? { opacity: 1, x: 0 } : {}}
        transition={{ duration: 0.3 }}
      >
        <span className="font-semibold block text-center dark:text-white">Skills</span>
        <h1 className="font-anton text-4xl text-center dark:text-white">Core Skills That Define My Expertise</h1>
