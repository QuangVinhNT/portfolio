...
const HomeSection = () => {
  ...
  return (
    <div id="#" className="mt-40" ref={ref}>
      <motion.div
      ...
      >
        ...
        <p className="text-center w-1/2 mx-auto my-6 dark:text-white">I am a passionate front-end intern eager to showcase my skills and projects. Let's connect and explore how I can contribute to your team.</p>
